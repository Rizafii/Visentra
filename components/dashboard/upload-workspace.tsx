        ...
        <CardContent className="p-6">
          {!uploadedImage ? (
            ...
            <div className="relative">
              <div className="aspect-video max-w-md mx-auto rounded-xl overflow-hidden bg-muted">
                <img
      ...
      <Card>
        <CardContent className="p-6">
          <div className="space-y-2">
            ...
            <Input
              id="productInfo"
              placeholder="Contoh: Keripik Singkong Rasa Pedas atau https://tokopedia.com/..."
              value={productInfo}
